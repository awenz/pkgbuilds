...
static const char selbgcolor[]      = "#0e0e0e";
...
/* tagging */
static const char *tags[] = { "1-main", "2-web", "3-dev", "4-doc", "5-media", "6-vm", "7-p2p", "8-var", "9-pim" };

static const Rule rules[] = {
	/* class        instance    title       tags mask     isfloating   monitor */
	{ "Gimp",       NULL,       NULL,       0,       True,        -1 },
	{ "Firefox",    NULL,       NULL,       2,       False,       -1 },
	{ "mplayer",    NULL,       NULL,       5,       False,       -1 },
	{ "virtualbox", NULL,       NULL,       6,       False,       -1 },
	{ "xpdf",       NULL,       NULL,       4,       False,       -1 },
	{ "eclipse",    NULL,       NULL,       3,       False,       -1 },
	{ "emacs",      NULL,       NULL,       3,       False,       -1 },
};
...
static const char *musicc[]         =   { "music_choose", NULL };
static const char *dmgcmd[]         =   { "google_dmenu", NULL };
...
static const char *pavolupcmd[]     =   { "pulsemix", "increase", "10", NULL };
static const char *pavoldowncmd[]   =   { "pulsemix", "decrease", "10", NULL };
static const char *pavoltogglecmd[] =   { "pulsemix", "toggle", NULL };
...
static Key keys[] = {
    ...
    { MODKEY,                       XK_s,      spawn,          {.v = musicc} },
    { MODKEY,                       XK_g,      spawn,          {.v = dmgcmd   } },
	{ MODKEY,                       XF86XK_AudioLowerVolume, spawn,          {.v = voldowncmd} },
	{ 0,                            XF86XK_AudioLowerVolume, spawn,          {.v = pavoldowncmd} },
	{ MODKEY,                       XF86XK_AudioRaiseVolume, spawn,          {.v = volupcmd} },
	{ 0,                            XF86XK_AudioRaiseVolume, spawn,          {.v = pavolupcmd} },
	{ MODKEY,                       XF86XK_AudioMute, spawn,          {.v = voltogglecmd} },
	{ 0,                            XF86XK_AudioMute, spawn,          {.v = pavoltogglecmd} },
